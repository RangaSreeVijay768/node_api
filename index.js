...
mongoose.connect("mongodb+srv://rangasreevijay768:" + process.env.MONGO_ATLAS_PASSWORD + "@test-crud-database.jngbtvf.mongodb.net/?retryWrites=true&w=majority&appName=test-crud-database", {
    ssl: true,
})
    .then(() => {
